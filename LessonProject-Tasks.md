...
UITableViewを配置できたら、追加読み込み機能を実装。
最下部に表示する際に、次の店舗の情報を取得するためにAPI通信が発生するように修正

### 課題２８：

追加読み込みの際に、エラーが発生した場合にエラーを表示しつつ、最下部のセルに「再度読み込み」ボタンを表示
ボタン押下した際にエラーが発生した通信を再開できるように修正。

### 課題２９：

プル更新ができるように修正
最上部を引っ張って、最新の情報を取得できるように修正
